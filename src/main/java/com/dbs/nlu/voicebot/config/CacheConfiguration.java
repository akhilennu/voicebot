package com.dbs.nlu.voicebot.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.dbs.nlu.voicebot.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.dbs.nlu.voicebot.repository.UserRepository.USERS_BY_EMAIL_CACHE);
