...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './intent.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_INTENT_LIST actions', async () => {
    ...
    it('dispatches FETCH_INTENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_INTENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_INTENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_INTENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_INTENT actions', async () => {
      const expectedActions = [
        {
