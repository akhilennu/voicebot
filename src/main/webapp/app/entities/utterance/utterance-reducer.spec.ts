...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './utterance.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_UTTERANCE_LIST actions', async () => {
    ...
    it('dispatches FETCH_UTTERANCE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_UTTERANCE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_UTTERANCE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_UTTERANCE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_UTTERANCE actions', async () => {
      const expectedActions = [
        {
