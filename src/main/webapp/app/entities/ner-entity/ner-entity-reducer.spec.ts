...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_NERENTITY_LIST actions', async () => {
    ...
    it('dispatches FETCH_NERENTITY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_NERENTITY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_NERENTITY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_NERENTITY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_NERENTITY actions', async () => {
      const expectedActions = [
        {
