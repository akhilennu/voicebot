...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TRANSCRIPTS_LIST actions', async () => {
    ...
    it('dispatches FETCH_TRANSCRIPTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_TRANSCRIPTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_TRANSCRIPTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_TRANSCRIPTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_TRANSCRIPTS actions', async () => {
      const expectedActions = [
        {
