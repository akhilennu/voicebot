...
To build the final jar and optimize the Voicebot application for production, run:
...
Then navigate to [http://localhost:8353](http://localhost:8353) in your browser.
